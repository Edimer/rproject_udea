...
::: footer
[*Indicadores del Banco Mundial*](https://openscapes.org/blog/2020-10-12-tidy-data/)
:::

## Ejemplo 1: valores en los nombres de las columnas (1/2) {.smaller}
...
- [Estadísticas Fedecafeteros](https://federaciondecafeteros.org/wp/estadisticas-cafeteras/)
...
- Frutales departamento del Valle del Cauca:
  -  [Superficie Sembrada](https://www.datos.gov.co/Agricultura-y-Desarrollo-Rural/Superficie-sembrada-de-frutales-en-el-Valle-del-Ca/vmj9-n8gi/about_data)
  - [Superficie Cosechada](https://www.datos.gov.co/Agricultura-y-Desarrollo-Rural/Superficie-cosechada-de-frutales-en-el-Valle-del-C/hasf-rpvk/about_data)
  - [Producción en Toneladas](https://www.datos.gov.co/Agricultura-y-Desarrollo-Rural/Producci-n-de-frutales-en-el-Valle-del-Cauca/8xap-gecf/about_data)
  - [Rendimiento en toneladas por hectárea](https://www.datos.gov.co/Agricultura-y-Desarrollo-Rural/Rendimiento-del-rea-cosechada-de-frutales-en-el-Va/ga4n-fzd9/about_data)
